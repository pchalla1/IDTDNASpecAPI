...
namespace IDTDNASpecAPI.Helpers
{
    /// <summary>
    ...
    public sealed class NLogger : ITraceWriter
    {
        ...
        private void Log(TraceRecord record)
        {
            ...
            if (record.Request != null)
            {
                ...
                if (record.Request.Headers != null && record.Request.Headers.Contains("SpecDelivery") && record.Request.Headers.GetValues("SpecDelivery") != null && record.Request.Headers.GetValues("Token").FirstOrDefault() != null)
                    message.Append("").Append("SpecDelivery: " + record.Request.Headers.GetValues("SpecDelivery").FirstOrDefault() + Environment.NewLine);
            }
